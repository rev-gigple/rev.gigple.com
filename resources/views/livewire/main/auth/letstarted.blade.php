        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="text-4xl font-bold">Let's get Started</h2>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="let_started_left text-end">
                        <h3 class="mt-5 text-2xl">I'm looking</h3>
                        <h3 class="text-4xl font-bold"><span>for work</span></h3>
                        <p class="mt-5 mb-5">Find great freelance and part-time <br> work with amazing companies.</p>
                        <div class="new_button_area flex justify-end">
                            <div class="lets-line h-px bg-gray-300 w-2/3 mt-2"></div>
                            <a href="#" class="lets_button lets_button_two px-6 py-2 bg-blue-500 text-white rounded-full">HIRE</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="let_started_right">
                        <h3 class="mt-5 text-2xl">I want to hire</h3>
                        <h3 class="text-4xl font-bold"><span>an expert</span></h3>
                        <p class="mt-5 mb-5">Find and collaborate <br> with a specialist in their field.</p>
                        <div class="new_button_area">
                            <a href="#" class="lets_button px-6 py-2 bg-blue-500 text-white rounded-full">HIRE</a>
                            <div class="lets-line h-px bg-gray-300 w-2/3 mt-2"></div>
                        </div>
                    </div>
                </div>
