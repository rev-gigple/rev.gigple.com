...
} elseif ($_instance->childHasBeenRendered('ZBWXOv6')) {
    $componentId = $_instance->getRenderedChildComponentId('ZBWXOv6');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZBWXOv6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZBWXOv6');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('ZBWXOv6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('WfrrFeO')) {
    $componentId = $_instance->getRenderedChildComponentId('WfrrFeO');
    $componentTag = $_instance->getRenderedChildComponentTagName('WfrrFeO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WfrrFeO');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('WfrrFeO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH E:\rev.gigple.com\resources\views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>