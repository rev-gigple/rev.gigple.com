...
} elseif ($_instance->childHasBeenRendered('l3501758611-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3501758611-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3501758611-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3501758611-1');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.overview');
    $html = $response->html();
    $_instance->logRenderedChild('l3501758611-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l3501758611-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3501758611-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3501758611-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3501758611-2');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.pricing');
    $html = $response->html();
    $_instance->logRenderedChild('l3501758611-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l3501758611-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3501758611-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3501758611-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3501758611-3');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.requirements');
    $html = $response->html();
    $_instance->logRenderedChild('l3501758611-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l3501758611-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l3501758611-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3501758611-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3501758611-4');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.gallery');
    $html = $response->html();
    $_instance->logRenderedChild('l3501758611-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /www/wwwroot/rev.gigple.com/resources/views/livewire/main/create/create.blade.php ENDPATH**/ ?>