...
} elseif ($_instance->childHasBeenRendered('f0oqbe2')) {
    $componentId = $_instance->getRenderedChildComponentId('f0oqbe2');
    $componentTag = $_instance->getRenderedChildComponentTagName('f0oqbe2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('f0oqbe2');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('f0oqbe2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('LRmGkZX')) {
    $componentId = $_instance->getRenderedChildComponentId('LRmGkZX');
    $componentTag = $_instance->getRenderedChildComponentTagName('LRmGkZX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LRmGkZX');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('LRmGkZX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
