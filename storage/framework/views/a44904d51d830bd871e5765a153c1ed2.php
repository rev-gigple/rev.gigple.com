...
} elseif ($_instance->childHasBeenRendered('B5bfyjj')) {
    $componentId = $_instance->getRenderedChildComponentId('B5bfyjj');
    $componentTag = $_instance->getRenderedChildComponentTagName('B5bfyjj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('B5bfyjj');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('B5bfyjj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('LE6vb3i')) {
    $componentId = $_instance->getRenderedChildComponentId('LE6vb3i');
    $componentTag = $_instance->getRenderedChildComponentTagName('LE6vb3i');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LE6vb3i');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('LE6vb3i', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /www/wwwroot/rev.gigple.com/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>