...
} elseif ($_instance->childHasBeenRendered('imVhvhR')) {
    $componentId = $_instance->getRenderedChildComponentId('imVhvhR');
    $componentTag = $_instance->getRenderedChildComponentTagName('imVhvhR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('imVhvhR');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('imVhvhR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('anvc3ZX')) {
    $componentId = $_instance->getRenderedChildComponentId('anvc3ZX');
    $componentTag = $_instance->getRenderedChildComponentTagName('anvc3ZX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('anvc3ZX');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('anvc3ZX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH E:\rev.gigple.com\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>