...
} elseif ($_instance->childHasBeenRendered('l2894433948-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2894433948-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2894433948-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2894433948-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l2894433948-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l2894433948-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2894433948-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2894433948-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2894433948-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l2894433948-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2894433948-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2894433948-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2894433948-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2894433948-2');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('l2894433948-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
 ...
 <?php $__env->stopPush(); ?>
 <?php /**PATH /www/wwwroot/rev.gigple.com/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>