...
} elseif ($_instance->childHasBeenRendered('7w9hGUa')) {
    $componentId = $_instance->getRenderedChildComponentId('7w9hGUa');
    $componentTag = $_instance->getRenderedChildComponentTagName('7w9hGUa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7w9hGUa');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('7w9hGUa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH E:\rev.gigple.com\resources\views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>