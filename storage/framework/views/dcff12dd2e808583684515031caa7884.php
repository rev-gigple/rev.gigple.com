...
} elseif ($_instance->childHasBeenRendered('AlC8Gdn')) {
    $componentId = $_instance->getRenderedChildComponentId('AlC8Gdn');
    $componentTag = $_instance->getRenderedChildComponentTagName('AlC8Gdn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AlC8Gdn');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('AlC8Gdn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://rev.gigple.com/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH /www/wwwroot/rev.gigple.com/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>