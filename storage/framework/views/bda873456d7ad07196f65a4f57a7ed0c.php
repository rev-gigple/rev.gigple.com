...
} elseif ($_instance->childHasBeenRendered('l1204209361-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1204209361-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1204209361-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1204209361-0');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l1204209361-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /www/wwwroot/rev.gigple.com/resources/views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/ ?>